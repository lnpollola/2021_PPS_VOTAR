...
// private httpPedido: PedidoService
  ...
  TraerVotante()
  {
    ...
    this.baseService.getItems("votar/Usuarios").then(usuarios => {

      this.listaVotantes = usuarios;
      this.votanteBuscado = this.listaVotantes.find(elem => (elem.idUsuario == this.idDocumento ));
     
      console.log(this.votanteBuscado);
      this.idDocumento = this.votanteBuscado.idUsuario;
